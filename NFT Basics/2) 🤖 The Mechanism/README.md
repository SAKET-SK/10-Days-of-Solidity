...
2) Real World Items : Deeds to a car, Tickets to a real world event, Tokenized invoices, Legal documents, Signatures
...
- This information is added to the blockchain where the NFT is being managed. The minting process, from a high level, has the following steps that it goes through:
...
Scarcity:
- The creator of an NFT gets to decide the scarcity of their asset.For example, consider a ticket to a sporting event. 
...
- In another case, the creator may want to create an NFT where only one is minted as a special rare collectible.
...
- This is still a developing concept but it's one of the most powerful. For example, the original owners of EulerBeats Originals earn an 8% royalty every time their NFT is sold. 
